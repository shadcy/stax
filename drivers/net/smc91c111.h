...
/* SMC91C111 Bank 2 FIFO Ports: 0x04 = RX FIFO (incoming), 0x05 = TX done FIFO (completed TX to free) */
#define SMC_TXFIFO   SMC_REG8(0x04)   /* TX done queue — completed TX packets to free */
#define SMC_RXFIFO   SMC_REG8(0x05)   /* RX packet queue — packet waiting to be read */
...
#define RCR_PRMS      0x0002  /* promiscuous — avoid on QEMU user-net */
